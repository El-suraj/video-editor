...
export default function ImageProps() {
  ...
  return (
    <div className="h-full flex flex-col overflor-auto">
      <div className="text-md text-[#e4e4e7] font-medium h-11 border-b  border-border flex items-center p-4 text-muted-foreground">
        Properties
      </div>
      <ScrollArea> 
        ...
        <div className="grid grid-cols-4 items-center mx-4 pb-4">
            <div className="flex">
            <Input
                className="w-[100%]"
                value={opacityPrev}
