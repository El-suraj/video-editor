...
import { fontCaseTypes, fontSizeTypes, stringContent } from "@/data/video";
  ...
  const TextProps = () => {
    ...
    return (
      <div className="h-full flex flex-col">
        <div className="text-md text-[#e4e4e7] font-medium h-11 border-b  border-border flex items-center px-4 py-4 text-muted-foreground">
          Properties
        </div>
        <ScrollArea> 
